...
<html lang="fr">
	...
	<nav class="navbar" navbar-default role=navigatio>
		...
		<form method="post" action="modifierEquipe.php">
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						<td><label for="numero" > Numero Employe: </label></td>
						<td><input type="numero" name="numeroEmploye" /></td>         
					</tr>
			...
			<input type="submit" value="Valider" onclick=window.location.href='formModifEquipe.php'/>
		</form>
		</section>
